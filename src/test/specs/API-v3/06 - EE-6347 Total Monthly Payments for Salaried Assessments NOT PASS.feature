Feature: Category A & B Financial Requirement - Solo & Combined Applications for Salaried Assessments NOT PASS
    ...
    Scenario: Category A - No dependents - Partner income not considered for Cat A - Annual check Not met - Multiple payments in the third month of the assessment range.
