Feature: Category B Financial Requirement - Solo & Combined Applications for Salaried Assessments
    ...
    # 01 Laura has no dependents. Her income history shows a payment within the employment check in the immediate 32 days but does not meet the threshold (2018-03-30). The total monthly payments in all the other months meet the monthly threshold with the minimum amounts and overall the annual threshold is met.
    Scenario: No dependents. Employment check fails as below threshold. Monthly payments over threshold.
    ...
    # 02 Derek has no dependents. His income history shows no payment within the employment check in the immediate 32 days (2018-03-30). The total monthly payments in all the other months meet the monthly threshold with the minimum amounts and overall the annual threshold is met.
    Scenario: No dependents. Employment check fails as no payment in last 32 days. Monthly payments over threshold.
    ...
    Scenario: No dependents. Employment check passes. One month below threshold.
    ...
    # 05 Chrissy has no dependents. Her income history shows a payment within the employment check in the immediate 32 days that meets the threshold (2018-03-30). The total monthly payments in all the other months meet the annual threshold but one month is missing
    Scenario: No dependents. Employment check passes. One month missing.
...
#           |            |         |             |              |                |                  |
   ...
   ##############
    ...
    Scenario: No dependents. Employment check fails, even with partner's salary.
    ...
    # 08 Jake has one dependent. His income history shows a payment within the employment check in the immediate 32 that meets the threshold (2018-03-30). The total monthly payments in all the other months do not meet the annual threshold.
    Scenario: One dependent. Employment check passes. One month below threshold.
    ...
    # 09 Joanne has two dependents. Her income history shows a payment within the employment check in the immediate 32 that meets the threshold (2018-03-30). The total monthly payments in all the other months do not meet the annual threshold.
    Scenario: Two dependents. Employment check passes. One month below threshold.
