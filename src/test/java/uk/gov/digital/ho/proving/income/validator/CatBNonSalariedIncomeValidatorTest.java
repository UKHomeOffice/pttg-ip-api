...
public class CatBNonSalariedIncomeValidatorTest {
    ...
    public void thatNoDataReturnsEmptyList() {
        Map<Integer, BigDecimal> aggregatedIncome = validator.aggregateMonthlyIncome(new ArrayList<>());
    ...
    public void thatSingleIncomeReturnsSingleMonth() {
        ...
        Map<Integer, BigDecimal> aggregatedIncome = validator.aggregateMonthlyIncome(incomes);
