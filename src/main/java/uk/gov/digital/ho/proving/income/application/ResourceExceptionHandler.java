...
public class ResourceExceptionHandler {
    ...
    ResponseEntity<BaseResponse> handle(AuditDataException exception) {
        log.error(append("errorCode", "0001"), exception.getMessage(), value(EVENT, INCOME_PROVING_AUDIT_FAILURE));
    ...
    public ResponseEntity<BaseResponse> handle(MissingServletRequestParameterException exception) {
        log.error(append("errorCode", "0001"), exception.getMessage(), value(EVENT, INCOME_PROVING_SERVICE_RESPONSE_ERROR));
    ...
    public ResponseEntity<BaseResponse> handle(NoHandlerFoundException exception) {
        log.error(append("errorCode", "0009"), exception.getMessage(), value(EVENT, INCOME_PROVING_SERVICE_RESPONSE_NOT_FOUND));
    ...
    public ResponseEntity<BaseResponse> handle(MethodArgumentTypeMismatchException exception) {
        log.error(append("errorCode", "0004"), exception.getMessage(), value(EVENT, INCOME_PROVING_SERVICE_RESPONSE_ERROR));
    ...
    ResponseEntity<BaseResponse> handle(ApplicationExceptions.EarningsServiceNoUniqueMatchException e) {
        log.error(append("errorCode", "0009"), "Could not retrieve earning details.", e, value(EVENT, INCOME_PROVING_SERVICE_RESPONSE_NOT_FOUND));
